...
show_menu() {
    ...
    echo -e "${BG_PURPLE} Hysteria2 & Cloudflare Tunnel Management Script (v4.9) ${ENDCOLOR}"
    echo
...
EOF
    cloudflared tunnel route dns "$TUNNEL_ID" "$DOMAIN"; success_echo "Cloudflare Tunnel 配置完成"
}
